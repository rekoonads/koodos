  ...
  useEffect(() => {
    if (isSignedIn && user) {
      ...
      const userNotifications = [
        { id: 1, title: "Welcome to KOODOS!", message: "Explore the latest gaming content", time: "Just now", unread: true },
        { id: 2, title: "New article published", message: "Check out the latest gaming review", time: "2 hours ago", unread: true },
        { id: 3, title: "Weekly newsletter", message: "Your gaming digest is ready", time: "1 day ago", unread: false }
      ]
            ...
            <div className="flex items-center gap-3">
              ...
              <div className="relative">
                ...
                >
                  ...
                  {isSignedIn && notifications.filter(n => n.unread).length > 0 && (
